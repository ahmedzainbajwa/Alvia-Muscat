    ...
    <nav className={clsx(styles.navbar, hidden && styles.hidden)}>
      ...
      {mobileMenuOpen && (
        <div className={styles.mobileMenu}>
          ...
          {/* Separator Line */}
          <div className={styles.mobileMenuSeparator}></div>
          {/* Language Changer */}
          <button 
          ...
          >
            <svg 
              className={styles.mobileLanguageIcon}
              viewBox="0 0 24 24" 
              fill="none" 
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            {language === 'en' ? (
              <Image 
                ...
                width={50} 
                height={20}
                className={styles.mobileArabicText}
              />
            ) : (
              <span className={styles.mobileLanguageText}>EN</span>
            )}
          </button>
        </div>
      )}
